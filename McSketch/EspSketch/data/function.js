...
for (var key in data2) {
 ...
 if(data2.iswificonnect=="1"){
	 document.getElementById('WifiIsConnect').innerHTML = "Wi-Fi is connect";
 } else {
	 document.getElementById('WifiIsConnect').innerHTML = "Wi-Fi is not connect!!!";
 }
 
 if(data2.newssid.length){
	 alert("Удачно. Рестартните.");
	 document.getElementById('ssid').value = data2.newssid;
	 document.getElementById('password').value = data2.newpass;
 }
